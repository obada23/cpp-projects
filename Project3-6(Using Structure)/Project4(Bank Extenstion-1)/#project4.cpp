...
enum enMainMenueOption { Show=1, Add=2, Delete=3, Update=4, Find=5, Transactions=6, Exit=7 };
...
void showMainMenueScreen()
{
    ...
    cout << "[7] Exit." << endl;
    cout <<"=================================================\n";
    performOption((enMainMenueOption)readYourChoose("Choose what do you want to do? [1 to 7]? "));
